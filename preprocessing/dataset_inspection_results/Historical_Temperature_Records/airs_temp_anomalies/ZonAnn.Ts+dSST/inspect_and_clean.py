...
def load_clean_and_inspect(file_path, dataset_dir, dataset_name):
    ...
    columns_to_convert = ['Glob', 'N.Hemi', 'S.Hemi', '24N-90N', '24S-24N', '90S-24S', '64N-90N', '44N-64N', '24N-44N', 'EQU-24N', '24S-EQU', '44S-24S', '64S-44S', '90S-64S']
...
def main():
    ...
    """
    file_path = '../../../../data/Historical_Temperature_Records/airs_temp_anomalies/ZonAnn.Ts+dSST.csv'
