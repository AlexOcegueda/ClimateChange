...
def load_clean_and_inspect(file_path, dataset_dir, dataset_name):
    ...
    data = pd.read_csv(file_path, names=column_names, comment='#', skiprows=45)
...
def main():
    ...
    """
    file_path = '../../../../data/Atmospheric_CO2_Concentrations/mauna-loa/co2_gr_mlo.csv'
    
    base_output_dir = '../../mauna_loa'
    dataset_name = 'co2_gr_mlo'
