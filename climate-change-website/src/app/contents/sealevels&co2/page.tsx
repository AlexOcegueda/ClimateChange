      ...
      <div className="container mx-auto text-center">
        ...
        <main className="bg-white p-8 mx-auto shadow-lg rounded-lg" style={{ maxWidth: '60rem', marginLeft: 'auto', marginRight: 'auto' }}>
          <blockquote className="text-3xl text-gray-500 mb-8">
            "How have global sea levels and CO2 concentrations changed over the past century, and what are the correlations between these changes and global temperature anomalies?"
          </blockquote>
          <h2 className="text-2xl font-bold mb-4">Why Sea Levels & CO2?</h2>
...
export default SeaLevelsCO2Page;
